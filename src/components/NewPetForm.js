    ...
    return (
      <form onSubmit={this.onFormSubmit}>
        ...
        <div>
          ...
          <input type="text" name="breed" value={this.state.breed} onChange={this.onInputChange} />
        </div>
        ...
        <div>
          ...
          <input type="text" name="about" value={this.state.about} onChange={this.onInputChange} />
        </div>
